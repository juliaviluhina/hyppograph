...
| II. Right-tier model usage | System under test stays on the fast tier (FR-009). The judge role is a declared, deliberate non-Claude choice limited to two rubric-graded assertion types (FR-010/010a/010b); everything else is deterministic. No tier escalation. | **PASS** |
